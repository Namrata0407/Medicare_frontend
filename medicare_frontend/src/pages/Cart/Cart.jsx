...
export const Cart = () => {
  ...
  const skeletonCount = useBreakpointValue({ base: 2, md: 3 });
        ...
        <div>
          {isLoading
            ? Array.from({ length: skeletonCount }).map((_, i) => (
                <div key={i} className="Item-conatiner" style={{marginBottom: '1rem'}}>
                  <div className="left-item-container" style={{width: '60%'}}>
                    <Skeleton height="20px" width="80%" mb={2} />
                    <SkeletonText mt="2" noOfLines={2} spacing="2" skeletonHeight="3" />
                  </div>
                  <div className="right-item-container" style={{width: '13%'}}>
                    <Skeleton height="30px" width="100%" mb={2} />
          ...
          <div className="neocoin-div1">
            <div className="left-neocoin-div1">
              {/* <img
                ...
                width="30px"
              /> */}
              <TbCoinRupeeFilled style={{marginBottom:"1rem",marginRight:"0.2rem"}} />
              <p>My NeuCoins</p>
            </div>
